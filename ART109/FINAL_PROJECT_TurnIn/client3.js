...
// client3.js
// A three.js scene which uses basic shapes to generate a scene which can be traversed with basic
// WASD and mouse controls, this scene is full screen with an overlay.
