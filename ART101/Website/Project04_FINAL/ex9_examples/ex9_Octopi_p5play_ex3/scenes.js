...
function main()  {
  ...
  this.enter = function() {
    ...
    //put the sprite on the stage
    helpbtnsprite.position.x = width  -100;
    ...
    this.draw = function()
    {
      ...
      checkKeys();  // get the key commands that will change the direction of octopi

    if (octopusmoves == true) {
       octoX += dirX;
       octoY += dirY;
       if (octoX > width) {
         octoX = 0;
