...
function setup() {
  ...
  thebackground = loadImage('images/backgroundForest.png');

  //create a sprite and add the 3 animations
  ghost = createSprite(400, 200, 50, 100);

  var myAnimation = ghost.addAnimation('floating', 'images/mainCharacterStanding01.png', 'images/mainCharacterStanding03.png');
  myAnimation.offY = 18;
  ...
  frame = loadImage('images/frame01.png');
}
